	...
	const CollisionComponent* other, Vector3& offset)
{
	...
	{
		//Z-axis
		float dz1 = (other->GetMin().z - GetMax().z); //Bottom of Object
		float dz2 = other->GetMax().z - GetMin().z; //Top of Object
		...
		else if (FinalMin == Math::Abs(dx1))
		{
			return CollSide::SideX1;
		}
		else if (FinalMin == Math::Abs(dx2))
		{
			return CollSide::SideX2;
		}
		else if (FinalMin == Math::Abs(dy1))
		{
			return CollSide::SideY1;
		}
		else if (FinalMin == Math::Abs(dy2))
		{
